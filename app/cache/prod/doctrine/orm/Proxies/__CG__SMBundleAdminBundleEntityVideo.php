 ...
 */
class Video extends \SM\Bundle\AdminBundle\Entity\Video implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'status', 'created_at', 'updated_at', 'url', 'created', 'updated', 'video_languages');
    }
