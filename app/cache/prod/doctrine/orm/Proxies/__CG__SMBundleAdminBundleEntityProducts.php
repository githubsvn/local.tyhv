...
class Products extends \SM\Bundle\AdminBundle\Entity\Products implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'price', 'unit', 'discount', 'thumb', 'amount', 'status', 'promotion', 'hot', 'created_at', 'updated_at', 'created', 'updated', 'product_languages', 'branch', 'media_id');
    }
