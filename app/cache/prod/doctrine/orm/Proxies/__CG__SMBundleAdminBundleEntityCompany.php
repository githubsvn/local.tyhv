...
class Company extends \SM\Bundle\AdminBundle\Entity\Company implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'charter_capital', 'phone', 'fax', 'mst', 'email', 'status', 'created_at', 'updated_at', 'thumb', 'website', 'type', 'created', 'updated', 'company_languages');
    }
