...
class __TwigTemplate_aabb0808337face354e537e32240dcdd extends Twig_Template
{
...
<form action=\"";
    ...
    <fieldset>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["lang"]) {
            ...
            echo "                    ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "mediacategory_languages"));
            foreach ($context['_seq'] as $context["_key"] => $context["mediacategoryLanguage"]) {
                // line 42
                echo "                        ";
                if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["mediacategoryLanguage"]) ? $context["mediacategoryLanguage"] : $this->getContext($context, "mediacategoryLanguage")), "vars"), "value"), "language"), "id") == $this->getAttribute((isset($context["lang"]) ? $context["lang"] : $this->getContext($context, "lang")), "id"))) {
                    // line 43
                    echo "                            ";
                    $context["currentAL"] = (isset($context["mediacategoryLanguage"]) ? $context["mediacategoryLanguage"] : $this->getContext($context, "mediacategoryLanguage"));
                    // line 44
                    echo "                        ";
                }
                // line 45
