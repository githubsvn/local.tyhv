...
class __TwigTemplate_2fdc3e3f94f72efb655b626a74003a8d extends Twig_Template
{
...
<form action=\"";
    ...
    <fieldset>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["lang"]) {
            ...
            echo "                    ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "category_languages"));
            foreach ($context['_seq'] as $context["_key"] => $context["categoryLanguage"]) {
                // line 42
                echo "                        ";
                if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["categoryLanguage"]) ? $context["categoryLanguage"] : $this->getContext($context, "categoryLanguage")), "vars"), "value"), "language"), "id") == $this->getAttribute((isset($context["lang"]) ? $context["lang"] : $this->getContext($context, "lang")), "id"))) {
                    // line 43
                    echo "                            ";
                    $context["currentAL"] = (isset($context["categoryLanguage"]) ? $context["categoryLanguage"] : $this->getContext($context, "categoryLanguage"));
                    // line 44
                    echo "                        ";
                }
                // line 45
