...
<div class=\"nav\" style=\"margin-bottom: 10px;\">
    ...
    <div class=\"btn-group pull-center\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["mediaType"]) {
            // line 31
            echo "                            ";
            if ((!(null === $this->getAttribute((isset($context["mediaType"]) ? $context["mediaType"] : $this->getContext($context, "mediaType")), "getCurrentLanguage")))) {
                // line 32
                echo "                                <option value=\"";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["mediaType"]) ? $context["mediaType"] : $this->getContext($context, "mediaType")), "id"), "html", null, true);
                echo "\" ";
                if (($this->getAttribute((isset($context["mediaType"]) ? $context["mediaType"] : $this->getContext($context, "mediaType")), "id") == (isset($context["type"]) ? $context["type"] : $this->getContext($context, "type")))) {
                    echo " selected=\"selected\"";
                }
                echo ">
                                    ";
                // line 33
                echo twig_escape_filter($this->env, twig_truncate_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["mediaType"]) ? $context["mediaType"] : $this->getContext($context, "mediaType")), "getCurrentLanguage"), "name"), 50), "html", null, true);
                echo "
                                </option>
                            ";
            }
    ...
    <table class=\"table table-bordered table-striped\" id=\"sortTable\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "\" name=\"checklist[]\" class=\"chkItem\"/> </td>
                <td><a href=\"";
            // line 62
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_media_show", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"), "html", null, true);
            echo "</a></td>
                <td>
                    <image src=\"";
            // line 64
            echo twig_escape_filter($this->env, ((isset($context["imgPath"]) ? $context["imgPath"] : $this->getContext($context, "imgPath")) . $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "name")), "html", null, true);
            ...
            echo "</td>
                <td>
                    ";
            // line 68
            if (($this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "active") == 1)) {
                // line 69
            ...
            echo "                </td>
                <td>
                    <a href=\"";
            // line 75
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_media_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
            ...
            echo "</a>
                    ...
                    <a class=\"delete\" rel=\"";
            // line 77
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_media_delete", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
...
";
    ...
    <ul>
        ...
        <li><a href=\"";
            // line 90
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_media", array("page" => (isset($context["previousPage"]) ? $context["previousPage"] : $this->getContext($context, "previousPage")))), "html", null, true);
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                if (((isset($context["page"]) ? $context["page"] : $this->getContext($context, "page")) == (isset($context["currentPage"]) ? $context["currentPage"] : $this->getContext($context, "currentPage")))) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_media", array("page" => (isset($context["page"]) ? $context["page"] : $this->getContext($context, "page")))), "html", null, true);
                    echo "\">";
      ...
      ";
            ...
            // line 98
            echo "        <li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_media", array("page" => (isset($context["nextPage"]) ? $context["nextPage"] : $this->getContext($context, "nextPage")))), "html", null, true);
            echo "\"><i class=\"icon-forward\"></i></a></li>
        <li><a href=\"";
            // line 99
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_media", array("page" => (isset($context["lastPage"]) ? $context["lastPage"] : $this->getContext($context, "lastPage")))), "html", null, true);
