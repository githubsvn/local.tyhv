    ...
    <fieldset>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["lang"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["menuLanguage"]) {
                // line 135
                echo "                        ";
                if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["menuLanguage"]) ? $context["menuLanguage"] : $this->getContext($context, "menuLanguage")), "vars"), "value"), "language"), "id") == $this->getAttribute((isset($context["lang"]) ? $context["lang"] : $this->getContext($context, "lang")), "id"))) {
                    // line 136
                    echo "                            ";
                    $context["currentAL"] = (isset($context["menuLanguage"]) ? $context["menuLanguage"] : $this->getContext($context, "menuLanguage"));
                    // line 137
                    echo "                        ";
                }
                // line 138
