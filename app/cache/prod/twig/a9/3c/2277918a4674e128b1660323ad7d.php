...
class __TwigTemplate_a93c2277918a4674e128b1660323ad7d extends Twig_Template
{
...
<form action=\"";
    ...
    <fieldset>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["lang"]) {
            ...
            echo "                    ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "branch_languages"));
            foreach ($context['_seq'] as $context["_key"] => $context["branchLanguage"]) {
                // line 42
                echo "                        ";
                if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["branchLanguage"]) ? $context["branchLanguage"] : $this->getContext($context, "branchLanguage")), "vars"), "value"), "language"), "id") == $this->getAttribute((isset($context["lang"]) ? $context["lang"] : $this->getContext($context, "lang")), "id"))) {
                    // line 43
                    echo "                            ";
                    $context["currentAL"] = (isset($context["branchLanguage"]) ? $context["branchLanguage"] : $this->getContext($context, "branchLanguage"));
                    // line 44
                    echo "                        ";
                }
                // line 45
