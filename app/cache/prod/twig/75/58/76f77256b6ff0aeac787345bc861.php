...
class __TwigTemplate_755876f77256b6ff0aeac787345bc861 extends Twig_Template
{
    ...
    {
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "branch"), "getName"), "html", null, true);
    }
  ...
  <ul>
    ...
    ";
        ...
        if (($this->getContext($context, "totalPage") > 0)) {
            ...
            // line 91
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("sm_front_view_product_cat", array("slug" => $this->env->getExtension('mtx.twig.build_url')->buildUrl($this->getAttribute($this->getAttribute($this->getContext($context, "branch"), "branch"), "id"), $this->getAttribute($this->getContext($context, "branch"), "name")), "page" => $this->getContext($context, "previousPage"))), "html", null, true);
            echo "\" title=\"<<\"><<</a></li>
                ";
            // line 92
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                if (($this->getContext($context, "i") <= $this->getContext($context, "totalPage"))) {
                    ...
                    echo "\"><a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("sm_front_view_product_cat", array("slug" => $this->env->getExtension('mtx.twig.build_url')->buildUrl($this->getAttribute($this->getAttribute($this->getContext($context, "branch"), "branch"), "id"), $this->getAttribute($this->getContext($context, "branch"), "name")), "page" => $this->getContext($context, "i"))), "html", null, true);
                    echo "\">";
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("sm_front_view_product_cat", array("slug" => $this->env->getExtension('mtx.twig.build_url')->buildUrl($this->getAttribute($this->getAttribute($this->getContext($context, "branch"), "branch"), "id"), $this->getAttribute($this->getContext($context, "branch"), "name")), "page" => $this->getContext($context, "nextPage"))), "html", null, true);
            echo "\" title=\">>\">>></a></li>
            </ul>
        </div>
    ";
