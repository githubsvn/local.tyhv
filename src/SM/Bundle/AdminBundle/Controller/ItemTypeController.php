...
use SM\Bundle\AdminBundle\Entity\ItemType;
use SM\Bundle\AdminBundle\Entity\ItemTypeLanguage;
use SM\Bundle\AdminBundle\Form\ItemTypeType;
...
class ItemTypeController extends Controller
{
    ...
    public function indexAction($page, $lang) {
        ...
        $total = $this->getDoctrine()
                ->getRepository("SMAdminBundle:ItemType")
                ->getTotal($criteria);
        ...
        return $this->render('SMAdminBundle:ItemType:index.html.twig', array(
            'entities' => $entities,
            'lastPage' => $lastPage,
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('SMAdminBundle:ItemType')->find($id);
        ...
        return $this->render('SMAdminBundle:ItemType:show.html.twig', array(
                    'entity' => $entity,
    ...
    public function newAction() {
        ...
        if (is_array($langList)) {
            foreach ($langList as $language) {
                $catLanguage = new ItemTypeLanguage();
                $catLanguage->setLanguage($language);
                $catLanguage->setItemType($entity);

                $entity->addItemTypeLanguage($catLanguage);
        ...
        $form = $this->createForm(new ItemTypeType(), $entity);
        ...
        if ($this->getRequest()->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                ...
                foreach ($entity->getItemTypeLanguages() as $catLanguage) {
                    $name = $catLanguage->getName();
                    if (empty($name)) {
                        $entity->removeItemTypeLanguage($catLanguage);
                ...
                if (!$referrer) {
                    ...
                    return $this->redirect(
                        $this->generateUrl('admin_itemtype')
                    );
                } else {
        ...
        return $this->render('SMAdminBundle:ItemType:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id) {
        ...
        $entity = $this->getDoctrine()->getRepository("SMAdminBundle:ItemType")
                ->find($id);
        ...
        if (!$entity) {
            ...
            return $this->redirect($this->generateUrl('admin_itemtype'));
        }
        ...
        if ($this->getRequest()->isMethod('POST')) {
            ...
            if (!is_null($parent)) {
                ...
                if ($parentId == $id) {
                    ...
                    return $this->redirect($this->generateUrl('admin_itemtype_edit', array('id' => $id)));
                }
            }
        ...
        return $this->render('SMAdminBundle:ItemType:edit.html.twig', array(
            'entity' => $entity,
            'form' => $form->createView(),
            'langList' => $langList,
            'defaultLanguage' => $defaultLanguage,
    ...
    public function upAction($id)
    {
        ...
        $repo = $em->getRepository('SMAdminBundle:ItemType');
