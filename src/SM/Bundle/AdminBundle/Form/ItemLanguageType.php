 ...
 */
class ItemLanguageType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('name', null, array('required' => false))
                ...
                ->add('oldprice', null, array('required' => false))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'SM\Bundle\AdminBundle\Entity\ItemLanguage'
        ));
    }
    ...
    {
        return 'sm_bundle_adminbundle_itemlanguagetype';
    }
}
